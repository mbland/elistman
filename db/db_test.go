...
var testSubscribers []*types.Subscriber = []*types.Subscriber{
	{
		Email:     "foo@test.com",
...
var testPendingSubscribers []*types.Subscriber = []*types.Subscriber{
	testSubscribers[1],
	testSubscribers[3],
	testSubscribers[5],
}

var testVerifiedSubscribers []*types.Subscriber = []*types.Subscriber{
	testSubscribers[0],
	testSubscribers[2],
	testSubscribers[4],
}
